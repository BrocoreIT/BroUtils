...
public static class CsvHelper
{
    ...
    /// <param name="filename">filename File to load</param>
    /// <param name="strict">If true, log errors if a line doesn't have enough fields as per the header. If false, ignores and just fills what it can</param>
    /// <returns></returns>
